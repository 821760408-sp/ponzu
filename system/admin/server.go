...
import (
	...
	"github.com/821760408-sp/ponzu/system"
...
func Run() {
	...
	http.HandleFunc("/admin/contents/import", user.Auth(importHandler))
	...
	staticDir := filepath.Join(pwd, "cmd", "ponzu", "vendor", "github.com", "821760408-sp", "ponzu", "system")
